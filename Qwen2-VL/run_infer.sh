...
# CUDA_VISIBLE_DEVICES=7 bash ./mpdoc_vqa_infer_mpdocvqa_dude_newsvqa_slidevqa.sh /gruntdata/heyuan67/huoluo.wx/models/Qwen__Qwen2-VL-7B-Instruct vqa-dude-mpdocvqa-val-unsupervised-cls-v3-top5 1 &> ./logs/notrain/vqa-dude-mpdocvqa-val-unsupervised-cls-v3-top5.log &
CUDA_VISIBLE_DEVICES=0,1,2,3 bash ./mpdoc_vqa_infer_mpdocvqa_dude_newsvqa_slidevqa.sh /gruntdata/heyuan67/huoluo.wx/models/Qwen__Qwen2-VL-7B-Instruct vqa-dude-mpdocvqa-val-unsupervised-cls-v4-top3_mix 4 &> ./logs/notrain/vqa-dude-mpdocvqa-val-unsupervised-cls-v4-top3_mix.log &
# CUDA_VISIBLE_DEVICES=2,3 bash ./mpdoc_vqa_infer_mpdocvqa_dude_newsvqa_slidevqa.sh /gruntdata/heyuan67/huoluo.wx/models/Qwen__Qwen2-VL-7B-Instruct vqa-dude-mpdocvqa-val-unsupervised-cls-v4-top5_mix 1 &> ./logs/notrain/vqa-dude-mpdocvqa-val-unsupervised-cls-v4-top5_mix.log &
...
CUDA_VISIBLE_DEVICES=4,5,6,7 bash ./mpdoc_vqa_infer_mpdocvqa_dude_newsvqa_slidevqa.sh /gruntdata/heyuan67/huoluo.wx/models/Qwen__Qwen2-VL-7B-Instruct vqa-dude-mpdocvqa-val-unsupervised-cls-v4-top3_mix-test2 4 &> ./logs/notrain/vqa-dude-mpdocvqa-val-unsupervised-cls-v4-top3_mix-test2.log &
# CUDA_VISIBLE_DEVICES=6,7 bash ./mpdoc_vqa_infer_mpdocvqa_dude_newsvqa_slidevqa.sh /gruntdata/heyuan67/huoluo.wx/models/Qwen__Qwen2-VL-7B-Instruct vqa-dude-mpdocvqa-val-unsupervised-cls-v4-top5_mix-test2 4 &> ./logs/notrain/vqa-dude-mpdocvqa-val-unsupervised-cls-v4-top5_mix-test2.log &
wait
