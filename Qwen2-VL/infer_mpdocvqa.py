...
def collate_fn(batches):
    ...
    return inputs, questions, question_ids, annotations
...
class VQADataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # max_pixels = self.image_process_args['max_pixels'] // len(data['images'])
        # if max_pixels < 147456:
        #     max_pixels = 147456
        # self.image_process_args['max_pixels'] = max_pixels

        # image_message = [
        #     {
        #         "role": "user",
        #         "content": [
        #             {"type": "image", "image": image_path, **self.image_process_args}
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": [{"type": "image", "image": image_path, **self.image_process_args} for image_path in image_paths] + [{"type": "text", "text": self.prompt+query}]
            },
        ]
...
def evaluate_chat_model(model, processor, image_process_args):
    ...
    for ds_name in args.datasets:
        ...
        for _, (inputs, questions, question_ids, annotations) in tqdm(enumerate(dataloader)):
